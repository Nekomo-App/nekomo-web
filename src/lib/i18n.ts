...
const STRINGS = {
  en: {
    ...
    'footer.demo': 'Nekomo — an original demo project. Not affiliated with any existing platform.',
  ...
  es: {
    ...
    'footer.demo': 'Nekomo — un proyecto de demostración original. Sin afiliación a plataformas existentes.',
  ...
  fr: {
    ...
    'footer.dmca': 'DMCA',
    'footer.contact': 'Contact',
    'footer.demo': 'Nekomo — projet de démonstration original. Aucune affiliation avec des plateformes existantes.',
  ...
  de: {
    ...
    'footer.demo': 'Nekomo — ein originales Demo-Projekt. Keine Verbindung zu bestehenden Plattformen.',
  ...
  ja: {
    ...
    'footer.demo': 'Nekomo — オリジナルのデモプロジェクト。既存のプラットフォームとは無関係です。',
    'settings.title': '設定',
